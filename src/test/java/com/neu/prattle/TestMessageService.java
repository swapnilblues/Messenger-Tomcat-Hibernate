...
//        message = messageServiceImpl.getMessageById(id);
//        assertEquals("Eden", message.getTo().getName());
//        assertEquals("Timo", message.getFrom().getName());
//        assertEquals("Chelsea", message.getContent());
        assertEquals(2,messages.size());
...
//    @Test
//    public void a16testMessageDeleteById() {
//
//        User userTo = new User("eden10", "eden@eden.com", "eden10", "al", "", "Eden");
//        User userFrom = new User("timo11", "timo11@eden.com", "timo11", "al", "", "Timo");
//
